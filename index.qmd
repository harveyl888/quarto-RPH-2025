...
-  General Guidelines
    ...
    -  Please be patient with us - hosting a virtual conference is different {{< li ebvizisb trigger=loop >}}
-  Asking for help
...
::: {.incremental .small}
-  SDTM Workshop (200+ attendees)
-  R/Pharma summit @ posit::conf 2025 (Sep 15)
...
-  R/Pharma Hangouts
-  Second R/Pharma genAI Day (Aug 19, 700+ attendees)
    - Check R/Pharma website or YouTube channel for recordings.
-  New R/Pharma website ([https://rinpharma.com/](https://rinpharma.com/))
:::
...
18 Free Workshops at R/Pharma this year {{< li rhmbrqqg trigger=loop class=larger >}}
...
:::{.space-image}
![](assets/R_Pharma_Store-1024.png){width=200px}
![](assets/pledgeto-1024.png){width=200px}
:::
...
-  Before/after R/Pharma and during breaks
    -  Network and visit Expo
        -  Showcase your open source and community contributions in an Expo booth ([https://bit.ly/4oT8Q1t](https://bit.ly/4oT8Q1t))
-  Schedule: [https://rpharma-2025.sessionize.com/](https://rpharma-2025.sessionize.com/)
-  Wednesday and Thursday - check schedule for pre-recorded talks
:::

:::{.space-image}
![](assets/Expo-1024.jpeg){width=200px}
![](assets/Schedule-1024.jpeg){width=200px}
:::

## SPECIAL ANNOUNCEMENTS

-  Wednesday: Joe Cheng and Eric Nantz (2PM EST)
    - The LLM Lounge: Live-coding and conversation on using AI for data science
-  Thursday: Panel - J&J Submission Journey (1:30PM EST)
    - look out for slido link in chat to submit questions
